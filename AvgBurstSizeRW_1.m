ConstructList= {'KrDist';'KrProx';'KrBothSep';'KrDistEmpty';'KrProxEmpty';'KrDistDuplicN';'KrProxDuplic';'KrBoth';'KrBothEmpty';'KrDist32C';'KrProx32C';'KrBothSep32C';'KrBoth32C';'Kr2xProx32C';'HbEmpty';'Kr2xProxEmpty';'KrDist17C';'Kr2xDist32C';'KrBoth17C'} %{'KrBoth';'KrDist';'KrProx';'KrProxAtDist';...
    ...
    for ee=1:NEmbryos
        ...
        for aa=1:length(APbinID)
            ...
            for bb=1:length(AmplitudeAP)
                ...
                AmpAP=[AmpAP;[BurstProperties(AmplitudeAP(bb)).BurstSize]'];  %put all durations at a given AP value in a column going down
                else
                    AmpAP=[AmpAP;nan];
                end
                end
...
MS2Convers=(377*((1.301+5.630)/1.5)); %Frnap * Telongation ((length of MS2 +rest of transcript) / elongation rate)
...
ylabel('number transcripts produced');
ylim([0 (350000/MS2Convers)]);
print( [FigDirect filesep 'SinglesBurstSize'],'-dsvg');
...
ylabel('number transcripts produced');
ylim([0 (350000/MS2Convers)]);
print( [FigDirect filesep 'HemiDistBurstSize'],'-dsvg');
...
ylabel('number transcripts produced');
ylim([0 (350000/MS2Convers)]);
print( [FigDirect filesep 'HemiProxBurstSize'],'-dsvg');
...
ylabel('number transcripts produced');
ylim([0 (350000/MS2Convers)]);
print( [FigDirect filesep 'HemiBothBurstSize'],'-dsvg');
...
ylabel('number transcripts produced');
ylim([0 (350000/MS2Convers)]);
print( [FigDirect filesep 'Hemi2xProxBurstSize'],'-dsvg');
%%
figure 
yyaxis left
...
print( [FigDirect filesep 'SinglesvBothBurstSize'],'-dsvg');
...
print( [FigDirect filesep 'DistalTempCompBurstSize'],'-dsvg');
...
print( [FigDirect filesep 'ProxTCompBurstSize'],'-dsvg');
...
print( [FigDirect filesep 'SepTCompBurstSize'],'-dsvg');
...
ylabel('number transcripts produced','Color','k');
ylim([0 (350000/MS2Convers)]);
%legend('both', 'both 32C','Location','Best');
print( [FigDirect filesep 'BothTCompBurstSize'],'-dsvg');
...
print( [FigDirect filesep '2xProxTCompBurstSize'],'-dsvg');

figure 
errorbar(Egglength, AvgAmpAllAP(6).AvgAmp, AvgAmpAllAP(6).All95Conf, 'Color', Colors(6).Color, 'LineWidth', 2.5);
hold on
errorbar(Egglength, AvgAmpAllAP(18).AvgAmp, AvgAmpAllAP(18).All95Conf, 'Color', Colors(18).Color, 'LineWidth', 2.5,'LineStyle','-.');
set(gca, 'FontSize', fontsize, 'FontName', fontname);
xlabel('% egg length');
ylabel('fluorescence intensity (AU)');
xlim([0 100]);
...
yyaxis right 
errorbar(Egglength, (AvgAmpAllAP(6).AvgAmp./MS2Convers), (AvgAmpAllAP(6).All95Conf./MS2Convers), 'Color', Colors(6).Color, 'LineWidth', 2.5,'LineStyle','-');
errorbar(Egglength, (AvgAmpAllAP(18).AvgAmp./MS2Convers), (AvgAmpAllAP(18).All95Conf./MS2Convers), 'Color', Colors(18).Color, 'LineWidth', 2.5,'LineStyle','-.');
ylabel('number transcripts produced','Color','k');
ylim([0 (350000/MS2Convers)]);
print( [FigDirect filesep '2xDistTCompBurstSize'],'-dsvg');
...
ylim([0 (350000/MS2Convers)]);
%legend('Distal', 'Distal 32C','Location','best');
print( [FigDirect filesep 'Dist17CCompBurstSize'],'-dsvg');

figure 
errorbar(Egglength, AvgAmpAllAP(8).AvgAmp, AvgAmpAllAP(8).All95Conf, 'Color', Colors(8).Color, 'LineWidth', 2.5);
hold on
errorbar(Egglength, AvgAmpAllAP(19).AvgAmp, AvgAmpAllAP(19).All95Conf, 'Color', Colors(19).Color, 'LineWidth', 2.5,'LineStyle','--');
set(gca, 'FontSize', fontsize, 'FontName', fontname);
xlabel('% egg length');
ylabel('fluorescence intensity (AU)');
%title('Mean burst amplitude');
...
yyaxis right
errorbar(Egglength, (AvgAmpAllAP(8).AvgAmp./MS2Convers), (AvgAmpAllAP(8).All95Conf./MS2Convers), 'Color', Colors(8).Color, 'LineWidth', 2.5,'LineStyle','-');
errorbar(Egglength, (AvgAmpAllAP(19).AvgAmp./MS2Convers), (AvgAmpAllAP(19).All95Conf./MS2Convers), 'Color', Colors(19).Color, 'LineWidth', 2.5,'LineStyle','--');
ylabel('number transcripts produced','Color','k');
ylim([0 (350000/MS2Convers)]);
%legend('Distal', 'Distal 32C','Location','best');
print( [FigDirect filesep 'Both17CCompBurstSize'],'-dsvg');
%%
figure
yyaxis left
